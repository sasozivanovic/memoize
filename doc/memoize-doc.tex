...
\begin{doc}{cmd={name=AdviceGetOriginal, par=\marg{namespace}\marg{control sequence}}}
  ...
  The full expansion of this macro produces the control sequence holding the
  original definition of \meta{control sequence}.
...
\begin{doc}{cmd={name=AdviceCsnameGetOriginal,
  ...
  of any command (even internal commands containing |@|, or |expl3| commands)
  into the context.
\end{doc}
